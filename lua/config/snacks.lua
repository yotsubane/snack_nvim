...
M.keys = {
  ...
  { "<leader>ff", function() Snacks.picker.files({on_show = function() vim.cmd.stopinsert() end,})  end, desc = "Find Files" },
  { "<leader>fg", function() Snacks.picker.git_files({on_show = function() vim.cmd.stopinsert() end,}) end, desc = "Find Git Files" },
